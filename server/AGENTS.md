...
- Keep paid inference outside storage transactions. Persist an attempt before dispatch; ambiguous interrupted attempts require manual retry. Keep TypeSafe defaults, timeout, retry policy, and usage logging.
